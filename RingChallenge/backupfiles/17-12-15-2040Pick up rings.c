...
#pragma config(Motor,  motor4,          slideMotor,    tmotorVexIQ, PIDControl, reversed, encoder)
...
task main()
{
	...
	forward(850,degrees,75); //Moving forward to blue rings.
	...
	backward(230,degrees,75); //Backing up into blue rings

	sleep(750);

	forward(200,milliseconds,25);
	...
	backward(535,degrees,100); //Backing up to put rings on pole.
	...
	backward(560,degrees,100); //Backing up to put rings on pole.
